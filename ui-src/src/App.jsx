  ...
  return (
    <div className="p-5 flex flex-col h-full justify-between">
      ...
      <div className="border-t border-border-main pt-4 mt-auto space-y-3">
        {/* GitHub 链接 */}
        <a
          href="https://github.com/MaleleStudySpace/wx-assist"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2.5 px-4 py-2.5 bg-bg-raised/80 rounded-full border border-border-main hover:bg-bg-raised transition-colors group"
        >
          <svg className="w-4 h-4 text-text-muted group-hover:text-text-main transition-colors" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"/>
          </svg>
          <span className="text-xs text-text-muted font-medium group-hover:text-text-main transition-colors">体验正式版</span>
          <svg className="w-3 h-3 text-text-muted group-hover:text-text-main transition-colors opacity-50" viewBox="0 0 256 256" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M200 48v128M136 152l64 64 64-64"/>
          </svg>
        </a>
